...
if (isset($_POST['submit'])) {
    // $name = $_POST['email']; if one submits javascript on the form it will run there for we need o make it not run by using html specail chars
    // $email = $_POST['email'];
    ...
    //FILTER_INPUT SAME AS ABOVE WITH MORE FUNCTIONALIT 
