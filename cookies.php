...
// Set a cookie
setcookie('name', 'Brad', time() + 86400 * 30); // 86400 = 1 day key ,value,timetamp to make it 30 day we can do 86400*30
...
// Delete a cookie
setcookie('name', '', time() - 86400);//set it time before this which will unset it
